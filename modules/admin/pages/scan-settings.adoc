...
// tag::webconfig-2[]
Параметр `ServicesPort` позволяет задать порт подключения к DVSupService для сканирования. Настройка выполняется в конфигурационном файле утилиты по адресу `/usr/lib/docsvision/dvsupservice/appsettings.json`.
