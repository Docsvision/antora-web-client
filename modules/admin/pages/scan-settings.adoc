...
****
Начиная с модуля {wc} версии {wc-cu5}, поддерживается два способа выбрать провайдера сканирования:

* При помощи настройки в конфигурационном файле сервиса, см. подробнее ниже
* Из интерфейса {of-mc} без необходимости работы с форматом `.json`: "xref:dev@mgmtconsole:servers:webclient-tools.adoc#supservice[DVSupService]"
****
