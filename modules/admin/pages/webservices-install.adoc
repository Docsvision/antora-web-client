...
. Когда DVWebTool устанавливается версия {wc}а без программы {pu}
...
* Из инсталлятора {wc}а, `{dv} web-client.msi`, компонент _WebToolBuilder_, см. подробнее "xref:install-server.adoc[]".
...
* image:layouts:buttons/three-dots.png[Три точки] -- кнопка для выбора манифеста приложения из файловой системы
