...
// ** Файлы утилиты будут расположены по пути: `C:\Program Files (x86)\Docsvision\WebClient\Tools\`
// ** Файлы DVWebTool будут расположены по пути (в манифесте прописан `localhost`): `C:\Program Files (x86)\Docsvision\WebClient\Site\Content\Tools\DVWebTool\`
...
** Файлы утилиты будут расположены по пути: `C:\Program Files (x86)\Docsvision\WebToolBuilder\`
** Файлы DVWebTool будут расположены по пути (в манифесте прописан `localhost`): `C:\Program Files (x86)\Docsvision\WebToolBuilder\DVWebTool\`
...
+
 ./WebToolBuilder C:\Program Files (x86)\Docsvision\WebToolBuilder\DVWebTool\DocsVision.DVWebTool.application
+
...
. В поле _Путь к манифесту приложения_ выберите файл манифеста `DocsVision.DVWebTool.application`. Расположение файла может отличаться в зависимости от способа установки WebToolBuilder, см. <<install-method,выше>>. После выбора файла автоматически будут заполнены другие поля.
+
