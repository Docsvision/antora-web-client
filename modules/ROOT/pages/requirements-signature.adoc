...
* КриптоПро CSP версии {csp-v} для работы простой подписи и расширения аутентификации ЕСИА.
...
+
** КриптоПро TSP Client и OCSP Client версии {tspcom-v} -- компонент необходим для создания усиленной подписи Cades-X-Long-Type-1.
