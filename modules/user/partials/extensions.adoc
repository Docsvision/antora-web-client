// tag::short[]
Данная возможность доступна только при установленном xref:GBL-3828@webclient:ROOT:requirements-software.adoc#browser[поддерживаемом] офисном пакете для следующих файлов: `.doc`, `.docx`, `.docm`, `.xls`, `.xlsx`, `.xlsm`, `.ppt`, `.pptx`, `.odt` и `.ods`.
// end::short[]
