...
TIP: Сборка и установка _DVWebTool_ делегированы утилите WebToolUtil, см. подробнее в разделе "xref:admin:webservices-install.adoc[]" для администратора {wc}а.
