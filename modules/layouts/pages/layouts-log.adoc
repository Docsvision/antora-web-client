...
Для программы {kvr} предусмотрен журнал работы. Журнал хранится по пути `C:/Program Files/Docsvision/WebClient/Logs/`. Имя файла журнала имеет следующий формат: `WebLayoutsDesigner PID \#\### ГГГГ-ММ-ДД`, где `\####` -- номер процесса.
...
. Найдите конфигурационный файл, расположенный в папке по адресу `C:/Program Files/Docsvision/WebClient/WebLayoutsDesigner.appsettings.json`.
