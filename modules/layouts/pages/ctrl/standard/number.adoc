...
NOTE: Свойство доступно только для дробных чисел и не влияет на сохранение значения. Количество знаков после запятой учитывается только при отображении, само значение сохраняется полностью.
