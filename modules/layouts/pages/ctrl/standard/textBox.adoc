...
Свойство предназначено для написания регулярных выражений (regexp) для задания масок с использованием синтаксиса языка Perl. Свойство доступно только для режимов редактирования _Редактирование_ и _По месту_. Значение можно задавать в редакторе, нажав кнопку image:buttons/three-dots.png[Три точки].
