...
. Поле с типом адреса (контактный, почтовый или юридический).
. Поле с индексом.
...
Определяет тип адреса, устанавливаемого в элементе управления: Контактный, Почтовый или Юридический.
