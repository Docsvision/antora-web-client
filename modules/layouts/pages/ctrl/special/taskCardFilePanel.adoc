...
include::partial$excerpts.adoc[tags=you-should-not-be-doing-that]
...
* Открывать файлы в xref:ROOT:requirements-software.adoc#browser[поддерживаемых] офисных приложениях.
